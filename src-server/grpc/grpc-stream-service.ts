...
function validateGrpcStreamStartPreflight(
  request: GrpcStreamStartRequest,
  tabId: string | undefined,
  started: number,
): GrpcRouteEnvelope<GrpcStreamStartResponse> | null {
...
function ownershipError(
  op: 'stream_events' | 'stream_send' | 'stream_end' | 'stream_cancel',
...
function hasNonEmptyInitialBody(body: Record<string, unknown>): boolean {
