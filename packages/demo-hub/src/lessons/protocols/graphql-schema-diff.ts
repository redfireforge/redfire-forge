...
Schema diff reports in JSON format can be consumed by CI/CD pipelines — a pre-deploy hook can fail the build if \`breakingCount > 0\` or if specific critical paths are removed. This turns manual "hope nobody broke anything" reviews into automated guardrails.`,
  ...
  <text x="350" y="21" text-anchor="middle" fill="#a8b8cc" font-size="11" font-weight="500">GraphQL Studio — Schema Diff &amp; Breaking Changes</text>
  ...
  <rect x="618" y="37" width="72" height="16" rx="4" fill="#3b82f6"/>
  ...
  <rect x="36" y="58" width="200" height="372" fill="#0f172a"/>
  <line x1="236" y1="58" x2="236" y2="430" stroke="#3b4a60" stroke-width="1"/>
  <rect x="36" y="58" width="200" height="22" fill="#0f172a"/>
  <rect x="40" y="60" width="56" height="18" rx="3" fill="#1e293b" stroke="#3b4a60" stroke-width="1"/>
  <text x="68" y="72" text-anchor="middle" font-size="7.5" fill="#f1f5f9">Query 1</text>
  <rect x="36" y="80" width="200" height="1" fill="#3b4a60"/>
  <text x="48" y="100" fill="#a78bfa" font-size="9" font-family="monospace">query</text>
  <text x="82" y="100" fill="#f1f5f9" font-size="9" font-family="monospace"> { health }</text>

  <!-- ── Schema Explorer (right side, ~464px) ──────────────────────────────── -->
  <rect x="238" y="58" width="462" height="372" fill="#0f172a"/>

  <!-- Schema Explorer header -->
  <rect x="238" y="58" width="462" height="22" fill="#1e293b"/>
  <line x1="238" y1="80" x2="700" y2="80" stroke="#3b4a60" stroke-width="1"/>
  <text x="248" y="73" font-size="8.5" font-weight="600" fill="#f1f5f9">Schema Explorer</text>

  <!-- Sub-tabs: Types | Changelog (active) -->
  <rect x="244" y="82" width="46" height="18" rx="3" fill="#0f172a" stroke="#3b4a60" stroke-width="1"/>
  <text x="267" y="94" text-anchor="middle" font-size="8" fill="#a8b8cc">Types</text>
  <rect x="294" y="82" width="68" height="18" rx="3" fill="#3b82f6"/>
  <text x="328" y="94" text-anchor="middle" font-size="8" fill="white" font-weight="700">Changelog</text>
  <!-- Save Snapshot button -->
  <rect x="590" y="82" width="100" height="18" rx="3" fill="#1a3324" stroke="#28c840" stroke-width="1"/>
  <text x="640" y="93" text-anchor="middle" font-size="7.5" fill="#28c840" font-weight="600">📷 Save Snapshot</text>

  <!-- Changelog panel content -->
  <rect x="238" y="100" width="462" height="200" fill="#0f172a"/>
  <line x1="238" y1="100" x2="700" y2="100" stroke="#3b4a60" stroke-width="0.5"/>

  <!-- Snapshot row 1 (current — just saved) -->
  <rect x="238" y="100" width="462" height="36" fill="color-mix(in srgb, #28c840 4%, #0f172a)"/>
  <line x1="238" y1="136" x2="700" y2="136" stroke="#3b4a60" stroke-width="0.5"/>
  <text x="252" y="116" font-size="8.5" font-weight="600" fill="#f1f5f9">Current snapshot</text>
  <text x="252" y="129" font-size="7" fill="#a8b8cc">2026-06-21 · 47 types · just saved</text>
  <rect x="590" y="106" width="40" height="22" rx="3" fill="#0f172a" stroke="#3b4a60" stroke-width="0.8"/>
  <text x="610" y="121" text-anchor="middle" font-size="7.5" fill="#a8b8cc">Diff</text>
  <!-- New badge -->
  <rect x="528" y="108" width="36" height="16" rx="3" fill="#1a3324" stroke="#28c840" stroke-width="0.5"/>
  <text x="546" y="119" text-anchor="middle" font-size="7" fill="#28c840">📷 new</text>

  <!-- Snapshot row 2 (baseline — seeded, selected) -->
  <rect x="238" y="136" width="462" height="36" fill="color-mix(in srgb, #3b82f6 7%, #1e293b)" stroke="#3b82f6" stroke-width="0.5"/>
  <line x1="238" y1="172" x2="700" y2="172" stroke="#3b4a60" stroke-width="0.5"/>
  <text x="252" y="152" font-size="8.5" font-weight="600" fill="#3b82f6">Prior Release — v1.0</text>
  <text x="252" y="165" font-size="7" fill="#a8b8cc">2026-06-01 · 45 types · baseline</text>
  <rect x="634" y="142" width="50" height="22" rx="3" fill="#3b82f6"/>
  <text x="659" y="157" text-anchor="middle" font-size="7.5" fill="white" font-weight="700">Diff →</text>
  <!-- Compare to dropdown -->
  <rect x="494" y="142" width="134" height="22" rx="3" fill="#0f172a" stroke="#3b4a60" stroke-width="0.8"/>
  <text x="502" y="156" font-size="7.5" fill="#a8b8cc">vs. Current Schema ▾</text>

  <!-- Snapshot row 3 (older) -->
  <rect x="238" y="172" width="462" height="36" fill="#0f172a"/>
  <text x="252" y="188" font-size="8.5" fill="#a8b8cc">Older snapshot</text>
  <text x="252" y="201" font-size="7" fill="#a8b8cc">2026-05-12 · 43 types</text>
  <rect x="634" y="178" width="50" height="22" rx="3" fill="#0f172a" stroke="#3b4a60" stroke-width="0.8"/>
  <text x="659" y="193" text-anchor="middle" font-size="7.5" fill="#a8b8cc">Diff</text>

  <!-- ── Schema Diff Modal (overlay) ───────────────────────────────────────── -->
  <!-- Modal backdrop -->
  <rect x="180" y="140" width="450" height="256" rx="8" fill="color-mix(in srgb, #0f172a 55%, transparent)" stroke="#3b4a60" stroke-width="1.5"/>

  <!-- Modal window -->
  <rect x="190" y="148" width="430" height="240" rx="7" fill="#1e293b" stroke="#3b4a60" stroke-width="2"/>

  <!-- Modal title bar -->
  <rect x="190" y="148" width="430" height="28" rx="7" fill="#152238"/>
  <rect x="190" y="164" width="430" height="12" fill="#152238"/>
  <text x="210" y="167" font-size="10" font-weight="700" fill="#f1f5f9">Schema Diff</text>
  <text x="260" y="167" font-size="8" fill="#a8b8cc">Prior Release v1.0  →  Current Schema</text>
  <!-- Close button -->
  <circle cx="605" cy="162" r="7" fill="#0f172a" stroke="#3b4a60" stroke-width="1"/>
  <text x="605" y="166" text-anchor="middle" font-size="9" fill="#a8b8cc">✕</text>

  <!-- Count badges -->
  <rect x="200" y="180" width="62" height="18" rx="4" fill="color-mix(in srgb, #ef4444 15%, #1e293b)" stroke="#ef4444" stroke-width="1"/>
  <text x="231" y="192" text-anchor="middle" font-size="8" fill="#ef4444" font-weight="700">🔴 2 Breaking</text>
  <rect x="268" y="180" width="46" height="18" rx="4" fill="color-mix(in srgb, #28c840 10%, #1e293b)" stroke="#28c840" stroke-width="1"/>
  <text x="291" y="192" text-anchor="middle" font-size="8" fill="#28c840" font-weight="700">🟢 3 Safe</text>
  <rect x="320" y="180" width="64" height="18" rx="4" fill="color-mix(in srgb, #f59e0b 10%, #1e293b)" stroke="#f59e0b" stroke-width="1"/>
  <text x="352" y="192" text-anchor="middle" font-size="8" fill="#f59e0b" font-weight="700">⚠ 1 Deprecated</text>

  <!-- Severity filter tabs -->
  <rect x="200" y="202" width="200" height="16" rx="3" fill="#0f172a"/>
  ...
  <rect x="252" y="202" width="38" height="16" rx="3" fill="#0f172a" stroke="#3b4a60" stroke-width="0.8"/>
  <text x="271" y="213" text-anchor="middle" font-size="7" fill="#a8b8cc">Safe</text>
  <rect x="294" y="202" width="54" height="16" rx="3" fill="#0f172a" stroke="#3b4a60" stroke-width="0.8"/>
  <text x="321" y="213" text-anchor="middle" font-size="7" fill="#a8b8cc">Deprecated</text>
  <!-- SDL Diff toggle -->
  <rect x="520" y="202" width="64" height="16" rx="3" fill="#0f172a" stroke="#3b4a60" stroke-width="0.8"/>
  <text x="552" y="213" text-anchor="middle" font-size="7" fill="#a8b8cc">⟺ SDL Diff</text>

  <!-- Diff rows table header -->
  <rect x="190" y="218" width="430" height="14" fill="#0f172a"/>
  <line x1="190" y1="218" x2="620" y2="218" stroke="#3b4a60" stroke-width="0.5"/>
  <text x="200" y="228" font-size="6.5" fill="#a8b8cc" font-weight="600">SEVERITY</text>
  <text x="260" y="228" font-size="6.5" fill="#a8b8cc" font-weight="600">PATH</text>
  <text x="410" y="228" font-size="6.5" fill="#a8b8cc" font-weight="600">CHANGE</text>

  <!-- Diff row 1 — Breaking: Query.users removed -->
  <rect x="190" y="232" width="430" height="22" fill="color-mix(in srgb, #ef4444 5%, #1e293b)"/>
  <line x1="190" y1="232" x2="620" y2="232" stroke="#3b4a60" stroke-width="0.3"/>
  <rect x="198" y="235" width="46" height="14" rx="3" fill="color-mix(in srgb, #ef4444 15%, #1e293b)" stroke="#ef4444" stroke-width="0.8"/>
  <text x="221" y="245" text-anchor="middle" font-size="7" fill="#ef4444" font-weight="600">Breaking</text>
  <text x="260" y="246" fill="#f1f5f9" font-size="8" font-family="monospace">Query.users</text>
  <text x="410" y="246" fill="#a8b8cc" font-size="7.5">Field removed</text>

  <!-- Diff row 2 — Breaking: Query.createOrder return change -->
  <rect x="190" y="254" width="430" height="22" fill="color-mix(in srgb, #ef4444 3%, #1e293b)"/>
  <line x1="190" y1="254" x2="620" y2="254" stroke="#3b4a60" stroke-width="0.3"/>
  <rect x="198" y="257" width="46" height="14" rx="3" fill="color-mix(in srgb, #ef4444 15%, #1e293b)" stroke="#ef4444" stroke-width="0.8"/>
  <text x="221" y="267" text-anchor="middle" font-size="7" fill="#ef4444" font-weight="600">Breaking</text>
  <text x="260" y="268" fill="#f1f5f9" font-size="8" font-family="monospace">Mutation.order</text>
  <text x="410" y="268" fill="#a8b8cc" font-size="7.5">Return type changed</text>

  <!-- Diff row 3 — Safe: User.email added -->
  <rect x="190" y="276" width="430" height="22" fill="color-mix(in srgb, #28c840 4%, #1e293b)"/>
  <line x1="190" y1="276" x2="620" y2="276" stroke="#3b4a60" stroke-width="0.3"/>
  <rect x="198" y="279" width="34" height="14" rx="3" fill="#1a3324" stroke="#28c840" stroke-width="0.8"/>
  <text x="215" y="289" text-anchor="middle" font-size="7" fill="#28c840" font-weight="600">Safe</text>
  <text x="260" y="290" fill="#f1f5f9" font-size="8" font-family="monospace">User.email</text>
  <text x="410" y="290" fill="#a8b8cc" font-size="7.5">New field added</text>

  <!-- Diff row 4 — Safe: Subscription.orderStatus added -->
  <rect x="190" y="298" width="430" height="22" fill="#1e293b"/>
  <line x1="190" y1="298" x2="620" y2="298" stroke="#3b4a60" stroke-width="0.3"/>
  <rect x="198" y="301" width="34" height="14" rx="3" fill="#1a3324" stroke="#28c840" stroke-width="0.8"/>
  <text x="215" y="311" text-anchor="middle" font-size="7" fill="#28c840" font-weight="600">Safe</text>
  <text x="260" y="312" fill="#f1f5f9" font-size="8" font-family="monospace">Subscription.orderStatus</text>
  <text x="410" y="312" fill="#a8b8cc" font-size="7.5">New subscription field</text>

  <!-- Modal footer -->
  <line x1="190" y1="322" x2="620" y2="322" stroke="#3b4a60" stroke-width="1"/>
  <rect x="190" y="322" width="430" height="26" fill="color-mix(in srgb, #3b82f6 4%, #1e293b)"/>
  <rect x="200" y="328" width="110" height="14" rx="4" fill="#3b82f6"/>
  <text x="255" y="338" text-anchor="middle" font-size="7.5" fill="white" font-weight="700">↓ Export diff as JSON</text>
  <text x="520" y="338" text-anchor="end" font-size="7" fill="#a8b8cc">schema-diff-20260621.json</text>
  ...
  <text x="40" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#f1f5f9">📷 Snapshot</text>
  <text x="40" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">save SDL</text>
  <line x1="74" y1="408" x2="106" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql12-arr)"/>
  <text x="140" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#f1f5f9">Changelog</text>
  <text x="140" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">timeline</text>
  <line x1="176" y1="408" x2="210" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql12-arr)"/>
  <text x="248" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#f1f5f9">Diff Modal</text>
  <text x="248" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">vs. current</text>
  <line x1="286" y1="408" x2="318" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql12-arr)"/>
  <rect x="328" y="398" width="46" height="14" rx="3" fill="color-mix(in srgb, #ef4444 15%, #1e293b)" stroke="#ef4444" stroke-width="0.8"/>
  <text x="351" y="408" text-anchor="middle" font-size="7.5" fill="#ef4444" font-weight="600">Breaking</text>
  <text x="351" y="420" text-anchor="middle" font-size="7" fill="#a8b8cc">removals</text>
  <line x1="378" y1="408" x2="408" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql12-arr)"/>
  <rect x="418" y="398" width="34" height="14" rx="3" fill="#1a3324" stroke="#28c840" stroke-width="0.8"/>
  <text x="435" y="408" text-anchor="middle" font-size="7.5" fill="#28c840" font-weight="600">Safe</text>
  <text x="435" y="420" text-anchor="middle" font-size="7" fill="#a8b8cc">additions</text>
  <line x1="455" y1="408" x2="483" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql12-arr)"/>
  <text x="518" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#f1f5f9">Filter</text>
  <text x="518" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">by severity</text>
  <line x1="546" y1="408" x2="576" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql12-arr)"/>
  <text x="624" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#3b82f6">Export JSON</text>
  <text x="624" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">CI/CD gate</text>
</svg>`,
  },
