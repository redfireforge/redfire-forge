...
describe('gql-performance-tracing lesson', () => {
  ...
  it('diagram uses fixed dark-theme hex palette', () => {
    expect(gqlPerformanceTracingLesson.concept.diagram).toContain('#0f172a');
    expect(gqlPerformanceTracingLesson.concept.diagram).toContain('#1e293b');
    expect(gqlPerformanceTracingLesson.concept.diagram).toContain('#3b4a60');
    expect(gqlPerformanceTracingLesson.concept.diagram).toContain('#3b82f6');
    expect(gqlPerformanceTracingLesson.concept.diagram).not.toContain('var(--');
  });
