...
**Why these two surfaces and not more?** The Builder SDL path is for the development workflow — you build, refine, copy, and paste the query into your codebase. The History cURL path is for the operational workflow — you run it, get a result, and share the exact HTTP request that produced it. Together they cover the two most common export needs without feature bloat.`,
  ...
  <text x="350" y="21" text-anchor="middle" fill="#a8b8cc" font-size="11" font-weight="500">GraphQL Studio — Export &amp; Share Queries</text>
  ...
  <!-- Mode buttons -->
  <rect x="380" y="37" width="52" height="16" rx="3" fill="#0f172a" stroke="#3b4a60" stroke-width="1"/>
  <text x="406" y="48" text-anchor="middle" font-size="8" fill="#a8b8cc">✏ Editor</text>
  <rect x="436" y="37" width="56" height="16" rx="3" fill="#3b82f6"/>
  ...
  <rect x="3" y="68" width="30" height="30" rx="4" fill="#0f172a"/>
  <text x="18" y="86" text-anchor="middle" font-size="12" opacity="0.3">📋</text>
  <rect x="3" y="104" width="30" height="30" rx="4" fill="#0f172a"/>
  <text x="18" y="122" text-anchor="middle" font-size="12" opacity="0.3">📁</text>

  <!-- ── Builder: Field Tree panel (left, ~210px) ───────────────────────────── -->
  <rect x="36" y="58" width="210" height="372" fill="#0f172a"/>
  <line x1="246" y1="58" x2="246" y2="430" stroke="#3b4a60" stroke-width="1"/>

  <!-- Field tree header -->
  <rect x="36" y="58" width="210" height="22" fill="#1e293b"/>
  <line x1="36" y1="80" x2="246" y2="80" stroke="#3b4a60" stroke-width="1"/>
  <text x="46" y="73" font-size="8.5" font-weight="600" fill="#f1f5f9">Field Tree</text>
  <rect x="200" y="62" width="38" height="14" rx="3" fill="#0f172a" stroke="#3b4a60" stroke-width="0.8"/>
  <text x="219" y="72" text-anchor="middle" font-size="7.5" fill="#a8b8cc">▸ Query</text>

  <!-- Field: health (checked) -->
  <rect x="36" y="80" width="210" height="22" fill="color-mix(in srgb, #28c840 6%, #0f172a)"/>
  ...
  <text x="70" y="95" font-size="9" fill="#f1f5f9" font-weight="500">health</text>
  <text x="222" y="95" text-anchor="end" font-size="7.5" fill="#a8b8cc">String!</text>

  <!-- Field: user (expanded, partial) -->
  <rect x="36" y="102" width="210" height="22" fill="color-mix(in srgb, #3b82f6 5%, #0f172a)"/>
  <line x1="36" y1="102" x2="246" y2="102" stroke="#3b4a60" stroke-width="0.5"/>
  <text x="46" y="116" font-size="9" fill="#3b82f6">▾</text>
  <rect x="56" y="106" width="14" height="14" rx="3" fill="color-mix(in srgb, #3b82f6 40%, #1e293b)" stroke="#3b82f6" stroke-width="1"/>
  <text x="63" y="116" text-anchor="middle" font-size="7" fill="#3b82f6" font-weight="700">–</text>
  <text x="78" y="116" font-size="9" fill="#f1f5f9" font-weight="500">user</text>
  <text x="222" y="116" text-anchor="end" font-size="7.5" fill="#a8b8cc">User</text>

  <!-- user argument: id -->
  <rect x="36" y="124" width="210" height="22" fill="#0f172a"/>
  <line x1="36" y1="124" x2="246" y2="124" stroke="#3b4a60" stroke-width="0.3"/>
  <text x="72" y="138" font-size="8" fill="#a8b8cc">id:</text>
  <rect x="86" y="128" width="80" height="14" rx="3" fill="#1e293b" stroke="#3b82f6" stroke-width="1"/>
  <text x="92" y="138" fill="#f1f5f9" font-size="8" font-family="monospace">usr-1</text>
  <!-- arg annotation -->
  <rect x="172" y="128" width="62" height="14" rx="3" fill="color-mix(in srgb, #f59e0b 10%, #1e293b)" stroke="#f59e0b" stroke-width="0.5"/>
  <text x="203" y="138" text-anchor="middle" font-size="6.5" fill="#f59e0b">required arg</text>

  <!-- user sub-fields: id, name -->
  <rect x="36" y="146" width="210" height="20" fill="#0f172a"/>
  <line x1="36" y1="146" x2="246" y2="146" stroke="#3b4a60" stroke-width="0.3"/>
  ...
  <text x="102" y="160" font-size="9" fill="#f1f5f9">id</text>
  <rect x="36" y="166" width="210" height="20" fill="#0f172a"/>
  <line x1="36" y1="166" x2="246" y2="166" stroke="#3b4a60" stroke-width="0.3"/>
  ...
  <text x="102" y="180" font-size="9" fill="#f1f5f9">name</text>

  <!-- Other fields (unchecked) -->
  <rect x="36" y="186" width="210" height="20" fill="#0f172a"/>
  <line x1="36" y1="186" x2="246" y2="186" stroke="#3b4a60" stroke-width="0.3"/>
  <rect x="48" y="190" width="14" height="14" rx="3" fill="#1e293b" stroke="#3b4a60" stroke-width="1"/>
  <text x="70" y="200" font-size="9" fill="#a8b8cc" opacity="0.5">posts</text>

  <!-- ── Builder: SDL Preview panel (center, ~228px) ────────────────────────── -->
  <rect x="248" y="58" width="228" height="372" fill="#0f172a"/>
  <line x1="476" y1="58" x2="476" y2="430" stroke="#3b4a60" stroke-width="1"/>

  <!-- SDL Preview header + toolbar -->
  <rect x="248" y="58" width="228" height="22" fill="#1e293b"/>
  <line x1="248" y1="80" x2="476" y2="80" stroke="#3b4a60" stroke-width="1"/>
  <text x="258" y="73" font-size="8.5" font-weight="600" fill="#f1f5f9">SDL Preview</text>
  <!-- Copy button (highlighted) -->
  <rect x="348" y="62" width="50" height="14" rx="4" fill="#243044" stroke="#3b82f6" stroke-width="1"/>
  <text x="373" y="72" text-anchor="middle" font-size="7.5" fill="#3b82f6" font-weight="600">⎘ Copy</text>
  <!-- Edit in Editor button -->
  <rect x="402" y="62" width="66" height="14" rx="4" fill="#3b82f6"/>
  <text x="435" y="72" text-anchor="middle" font-size="7.5" fill="white" font-weight="600">✏ Edit in Editor</text>

  <!-- SDL code content -->
  <rect x="248" y="80" width="228" height="200" fill="#0f172a"/>
  <!-- Line numbers -->
  <text x="260" y="100" fill="#a8b8cc" font-size="7.5" opacity="0.5" font-family="monospace">1</text>
  <text x="260" y="115" fill="#a8b8cc" font-size="7.5" opacity="0.5" font-family="monospace">2</text>
  <text x="260" y="130" fill="#a8b8cc" font-size="7.5" opacity="0.5" font-family="monospace">3</text>
  <text x="260" y="145" fill="#a8b8cc" font-size="7.5" opacity="0.5" font-family="monospace">4</text>
  <text x="260" y="160" fill="#a8b8cc" font-size="7.5" opacity="0.5" font-family="monospace">5</text>
  <text x="260" y="175" fill="#a8b8cc" font-size="7.5" opacity="0.5" font-family="monospace">6</text>
  <text x="260" y="190" fill="#a8b8cc" font-size="7.5" opacity="0.5" font-family="monospace">7</text>
  <text x="260" y="205" fill="#a8b8cc" font-size="7.5" opacity="0.5" font-family="monospace">8</text>
  <!-- Query code -->
  <text x="278" y="100" fill="#a78bfa" font-size="9" font-family="monospace">query</text>
  <text x="312" y="100" fill="#f1f5f9" font-size="9" font-family="monospace"> ExportDemo {</text>
  <text x="278" y="115" fill="#a8b8cc" font-size="9" font-family="monospace">  health</text>
  <text x="278" y="130" fill="#60a5fa" font-size="9" font-family="monospace">  user</text>
  <text x="312" y="130" fill="#f1f5f9" font-size="9" font-family="monospace">(id: </text>
  <text x="340" y="130" fill="#f59e0b" font-size="9" font-family="monospace">"usr-1"</text>
  <text x="377" y="130" fill="#f1f5f9" font-size="9" font-family="monospace">) {</text>
  <text x="278" y="145" fill="#a8b8cc" font-size="9" font-family="monospace">    id</text>
  <text x="278" y="160" fill="#a8b8cc" font-size="9" font-family="monospace">    name</text>
  <text x="278" y="175" fill="#f1f5f9" font-size="9" font-family="monospace">  }</text>
  <text x="278" y="190" fill="#f1f5f9" font-size="9" font-family="monospace">}</text>

  <!-- Live update badge -->
  <rect x="258" y="206" width="80" height="14" rx="3" fill="color-mix(in srgb, #28c840 10%, #1e293b)" stroke="#28c840" stroke-width="0.8"/>
  ...
  <rect x="478" y="58" width="222" height="372" fill="#0f172a"/>

  <!-- History panel header -->
  <rect x="478" y="58" width="222" height="22" fill="#1e293b"/>
  <line x1="478" y1="80" x2="700" y2="80" stroke="#3b4a60" stroke-width="1"/>
  <text x="488" y="73" font-size="8.5" font-weight="600" fill="#f1f5f9">History</text>
  <text x="688" y="73" text-anchor="end" font-size="7.5" fill="#a8b8cc">Clear ✕</text>

  <!-- History entry (right-clicked → active) -->
  <rect x="478" y="80" width="222" height="36" fill="#152238" stroke="#3b82f6" stroke-width="0.5"/>
  <text x="488" y="96" font-size="8" font-weight="600" fill="#3b82f6">query ExportDemo { ... }</text>
  <text x="488" y="109" font-size="7" fill="#a8b8cc">200 OK · 18ms · 3:31 PM</text>
  <rect x="668" y="84" width="28" height="14" rx="3" fill="#1a3324" stroke="#28c840" stroke-width="0.5"/>
  <text x="682" y="95" text-anchor="middle" font-size="7" fill="#28c840">✓ 200</text>

  <!-- Context menu (floating) -->
  <rect x="488" y="120" width="160" height="112" rx="5" fill="#1e293b" stroke="#3b4a60" stroke-width="1.5" filter="drop-shadow(0 4px 12px rgba(0,0,0,0.4))"/>
  <!-- Menu items -->
  <rect x="488" y="120" width="160" height="24" rx="5" fill="#1e293b"/>
  <rect x="488" y="136" width="160" height="8" fill="#1e293b"/>
  <text x="504" y="136" font-size="8.5" fill="#f1f5f9">Preview</text>
  <line x1="488" y1="144" x2="648" y2="144" stroke="#3b4a60" stroke-width="0.5"/>
  <text x="504" y="156" font-size="8.5" fill="#f1f5f9">Load into Editor</text>
  <line x1="488" y1="162" x2="648" y2="162" stroke="#3b4a60" stroke-width="0.5"/>
  <text x="504" y="174" font-size="8.5" fill="#f1f5f9">Run</text>
  <line x1="488" y1="180" x2="648" y2="180" stroke="#3b4a60" stroke-width="0.5"/>
  <!-- Highlighted: Copy as cURL -->
  <rect x="490" y="183" width="156" height="22" rx="3" fill="#243044"/>
  <text x="504" y="198" font-size="8.5" fill="#3b82f6" font-weight="700">⎘ Copy as cURL</text>
  <rect x="616" y="186" width="26" height="14" rx="3" fill="#3b82f6"/>
  <text x="629" y="196" text-anchor="middle" font-size="7.5" fill="white" font-weight="600">⌘C</text>
  <line x1="488" y1="205" x2="648" y2="205" stroke="#3b4a60" stroke-width="0.5"/>
  <text x="504" y="217" font-size="8.5" fill="#f1f5f9">Delete</text>

  <!-- cURL output preview -->
  <rect x="488" y="244" width="200" height="70" rx="4" fill="#0f172a" stroke="#3b4a60" stroke-width="1"/>
  <text x="496" y="258" font-size="7" fill="#a8b8cc" font-family="monospace">curl -X POST \\</text>
  <text x="496" y="270" font-size="7" fill="#a8b8cc" font-family="monospace">  localhost:4010/graphql \\</text>
  <text x="496" y="282" font-size="7" fill="#a8b8cc" font-family="monospace">  -H 'Content-Type: ...' \\</text>
  <text x="496" y="294" font-size="7" fill="#28c840" font-family="monospace">  -d '&#123;"query":"..."&#125;'</text>
  <!-- cURL badge -->
  <rect x="488" y="318" width="110" height="16" rx="3" fill="#1a2740" stroke="#3b82f6" stroke-width="0.8"/>
  <text x="543" y="329" text-anchor="middle" font-size="7" fill="#3b82f6">→ clipboard (paste anywhere)</text>

  <!-- ── Bottom legend ─────────────────────────────────────────────────────── -->
  <line x1="0" y1="390" x2="700" y2="390" stroke="#3b4a60" stroke-width="1"/>
  <rect x="0" y="390" width="700" height="40" fill="#0f172a"/>
  <defs>
    <marker id="gql10-arr" markerWidth="5" markerHeight="5" refX="3.5" refY="2.5" orient="auto">
      <path d="M1,1 L4,2.5 L1,4 Z" fill="#3b82f6"/>
    </marker>
  </defs>
  <text x="46" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#f1f5f9">Builder</text>
  <text x="46" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">field tree</text>
  <line x1="80" y1="408" x2="108" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql10-arr)"/>
  <text x="138" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#f1f5f9">SDL Preview</text>
  <text x="138" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">live SDL</text>
  <line x1="175" y1="408" x2="205" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql10-arr)"/>
  <text x="230" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#f1f5f9">⎘ Copy</text>
  <text x="230" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">clipboard</text>
  <text x="262" y="412" fill="#a8b8cc" font-size="8">or</text>
  <line x1="272" y1="408" x2="300" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql10-arr)"/>
  <text x="332" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#f1f5f9">Edit in Editor</text>
  <text x="332" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">Monaco (1-way)</text>
  <line x1="386" y1="408" x2="416" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql10-arr)"/>
  <text x="448" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#f1f5f9">Execute</text>
  <text x="448" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">→ History</text>
  <line x1="480" y1="408" x2="510" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql10-arr)"/>
  <text x="560" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#3b82f6">⎘ Copy as cURL</text>
  <text x="560" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">terminal / CI / team</text>
</svg>`,
  },
  ...
  steps: [
    ...
    // ── Step 5: Execute exported query ─────────────────────────────────────
    {
      ...
      description:
        'Enable **Data only** in the response status bar so the Body tab shows just `data` and `errors` — many tracing-enabled servers attach large `extensions` blocks that clutter sharing workflows.\n\n' +
