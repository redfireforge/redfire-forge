...
**Why distribution matters:** The p95 latency (the 95th percentile — the slowest 5% of requests) is what your users actually experience at scale. A histogram with a long right tail (occasional 500ms spikes) behaves very differently from a narrow one (consistent 50ms). The histogram strip gives you this signal without running a full load test.`,
  ...
  <text x="350" y="21" text-anchor="middle" fill="#a8b8cc" font-size="11" font-weight="500">GraphQL Studio — Performance Tracing</text>
  ...
  <rect x="556" y="37" width="36" height="16" rx="3" fill="color-mix(in srgb, #f59e0b 15%, #1e293b)" stroke="#f59e0b" stroke-width="1"/>
  <text x="574" y="48" text-anchor="middle" font-size="8" fill="#f59e0b" font-weight="700">≈5</text>
  <!-- Badge annotation -->
  <rect x="480" y="37" width="72" height="16" rx="3" fill="color-mix(in srgb, #f59e0b 8%, #1e293b)" stroke="#f59e0b" stroke-width="0.5"/>
  <text x="516" y="48" text-anchor="middle" font-size="7" fill="#f59e0b">Complexity: ≈5</text>
  <rect x="596" y="37" width="72" height="16" rx="4" fill="#3b82f6"/>
  ...
  <rect x="36" y="58" width="240" height="372" fill="#0f172a"/>
  <line x1="276" y1="58" x2="276" y2="430" stroke="#3b4a60" stroke-width="1"/>

  <!-- Editor header -->
  <rect x="36" y="58" width="240" height="22" fill="#0f172a"/>
  <rect x="40" y="60" width="56" height="18" rx="3" fill="#1e293b" stroke="#3b4a60" stroke-width="1"/>
  <text x="68" y="72" text-anchor="middle" font-size="7.5" fill="#f1f5f9" font-weight="500">Query 1</text>
  <rect x="36" y="80" width="240" height="1" fill="#3b4a60"/>

  <!-- Query code -->
  <rect x="36" y="81" width="240" height="200" fill="#0f172a"/>
  <text x="48" y="98" fill="#a8b8cc" font-size="7" opacity="0.5" font-family="monospace">1</text>
  <text x="48" y="112" fill="#a8b8cc" font-size="7" opacity="0.5" font-family="monospace">2</text>
  <text x="48" y="126" fill="#a8b8cc" font-size="7" opacity="0.5" font-family="monospace">3</text>
  <text x="48" y="140" fill="#a8b8cc" font-size="7" opacity="0.5" font-family="monospace">4</text>
  <text x="48" y="154" fill="#a8b8cc" font-size="7" opacity="0.5" font-family="monospace">5</text>
  <text x="48" y="168" fill="#a8b8cc" font-size="7" opacity="0.5" font-family="monospace">6</text>
  <text x="48" y="182" fill="#a8b8cc" font-size="7" opacity="0.5" font-family="monospace">7</text>
  <text x="60" y="98" fill="#a78bfa" font-size="9" font-family="monospace">query</text>
  <text x="95" y="98" fill="#f1f5f9" font-size="9" font-family="monospace"> TracingDemo {</text>
  <text x="60" y="112" fill="#a8b8cc" font-size="9" font-family="monospace">  health</text>
  <text x="60" y="126" fill="#60a5fa" font-size="9" font-family="monospace">  user</text>
  <text x="90" y="126" fill="#f1f5f9" font-size="9" font-family="monospace">(id: </text>
  <text x="113" y="126" fill="#f59e0b" font-size="9" font-family="monospace">"usr-1"</text>
  <text x="150" y="126" fill="#f1f5f9" font-size="9" font-family="monospace">) {</text>
  <text x="60" y="140" fill="#a8b8cc" font-size="9" font-family="monospace">    id</text>
  <text x="60" y="154" fill="#a8b8cc" font-size="9" font-family="monospace">    name</text>
  <text x="60" y="168" fill="#f1f5f9" font-size="9" font-family="monospace">  }</text>
  <text x="60" y="182" fill="#f1f5f9" font-size="9" font-family="monospace">}</text>

  <!-- ── Response viewer (right, ~424px) ───────────────────────────────────── -->
  <rect x="278" y="58" width="422" height="372" fill="#0f172a"/>

  <!-- Response tab bar -->
  <rect x="278" y="58" width="422" height="26" fill="#1e293b"/>
  <line x1="278" y1="84" x2="700" y2="84" stroke="#3b4a60" stroke-width="1"/>
  <!-- Response tab -->
  <rect x="284" y="62" width="62" height="18" rx="3" fill="#0f172a" stroke="#3b4a60" stroke-width="1"/>
  <text x="315" y="74" text-anchor="middle" font-size="8" fill="#a8b8cc">Response</text>
  <!-- Tracing tab (active) -->
  <rect x="350" y="62" width="60" height="18" rx="3" fill="#3b82f6"/>
  <text x="380" y="74" text-anchor="middle" font-size="8" fill="white" font-weight="700">⏱ Tracing</text>
  <!-- Tracing badge in response header -->
  <rect x="570" y="64" width="60" height="14" rx="3" fill="#243044" stroke="#3b82f6" stroke-width="1"/>
  <text x="600" y="74" text-anchor="middle" font-size="7.5" fill="#3b82f6" font-weight="600">⏱ Tracing ●</text>
  <!-- Badge annotation -->
  <line x1="600" y1="78" x2="600" y2="94" stroke="#3b82f6" stroke-width="0.8" stroke-dasharray="2 2"/>
  <rect x="550" y="94" width="100" height="13" rx="3" fill="#1a2740" stroke="#3b4a60" stroke-width="0.5"/>
  <text x="600" y="103" text-anchor="middle" font-size="6.5" fill="#3b82f6">trace data present</text>

  <!-- Tracing controls bar -->
  <rect x="278" y="84" width="422" height="22" fill="#1e293b"/>
  <line x1="278" y1="106" x2="700" y2="106" stroke="#3b4a60" stroke-width="0.5"/>
  <text x="288" y="98" font-size="8" fill="#a8b8cc">Total: 42ms</text>
  <text x="370" y="98" font-size="8" fill="#a8b8cc">3 resolvers</text>
  <!-- Sort button -->
  <rect x="560" y="87" width="82" height="14" rx="3" fill="#3b82f6"/>
  ...
  <rect x="278" y="106" width="422" height="30" fill="#0f172a"/>
  <line x1="278" y1="106" x2="700" y2="106" stroke="#3b4a60" stroke-width="0.5"/>
  <text x="288" y="118" font-size="8" fill="#f1f5f9">Query.user</text>
  <text x="288" y="130" font-size="7" fill="#a8b8cc">30ms</text>
  <!-- Timeline track -->
  <rect x="390" y="112" width="290" height="18" rx="2" fill="color-mix(in srgb, #3b82f6 5%, #0f172a)"/>
  ...
  <!-- Hover tooltip -->
  <rect x="540" y="94" width="110" height="26" rx="4" fill="#1e293b" stroke="#3b4a60" stroke-width="1.5"/>
  <text x="595" y="105" text-anchor="middle" font-size="7" fill="#f1f5f9">Start: 2ms</text>
  ...
  <rect x="278" y="136" width="422" height="30" fill="#0f172a"/>
  <line x1="278" y1="136" x2="700" y2="136" stroke="#3b4a60" stroke-width="0.5"/>
  <text x="288" y="148" font-size="8" fill="#f1f5f9">Query.health</text>
  <text x="288" y="160" font-size="7" fill="#a8b8cc">8ms</text>
  <rect x="390" y="142" width="290" height="18" rx="2" fill="color-mix(in srgb, #3b82f6 5%, #0f172a)"/>
  ...
  <rect x="278" y="166" width="422" height="30" fill="#0f172a"/>
  <line x1="278" y1="166" x2="700" y2="166" stroke="#3b4a60" stroke-width="0.5"/>
  <text x="288" y="178" font-size="8" fill="#a8b8cc">User.name</text>
  <text x="288" y="190" font-size="7" fill="#a8b8cc">4ms</text>
  <rect x="390" y="172" width="290" height="18" rx="2" fill="color-mix(in srgb, #3b82f6 5%, #0f172a)"/>
  ...
  <!-- Color legend -->
  <rect x="278" y="198" width="422" height="20" fill="#1e293b"/>
  <line x1="278" y1="198" x2="700" y2="198" stroke="#3b4a60" stroke-width="0.5"/>
  <rect x="290" y="203" width="8" height="8" rx="1" fill="#28c840"/>
  <text x="302" y="210" font-size="7" fill="#a8b8cc">&lt; 50ms</text>
  <rect x="340" y="203" width="8" height="8" rx="1" fill="#f59e0b"/>
  <text x="352" y="210" font-size="7" fill="#a8b8cc">50–200ms</text>
  <rect x="408" y="203" width="8" height="8" rx="1" fill="#ef4444"/>
  <text x="420" y="210" font-size="7" fill="#a8b8cc">&gt; 200ms</text>
  <text x="560" y="210" font-size="7" fill="#a8b8cc">hover row → tooltip</text>

  <!-- ── Histogram strip ────────────────────────────────────────────────────── -->
  <line x1="278" y1="218" x2="700" y2="218" stroke="#3b4a60" stroke-width="1"/>
  <rect x="278" y="218" width="422" height="16" fill="#1e293b"/>
  <text x="288" y="229" font-size="8" font-weight="600" fill="#f1f5f9">Latency Histogram</text>
  <text x="560" y="229" text-anchor="end" font-size="7.5" fill="#a8b8cc">avg: 38ms · p95: 58ms</text>
  <!-- Histogram bars -->
  <rect x="278" y="234" width="422" height="50" fill="#0f172a"/>
  <!-- x-axis labels -->
  <text x="290" y="278" font-size="6.5" fill="#a8b8cc">0ms</text>
  <text x="370" y="278" font-size="6.5" fill="#a8b8cc">30ms</text>
  <text x="450" y="278" font-size="6.5" fill="#a8b8cc">60ms</text>
  <text x="530" y="278" font-size="6.5" fill="#a8b8cc">90ms</text>
  <text x="610" y="278" font-size="6.5" fill="#a8b8cc">120ms</text>
  <!-- Histogram bars (distribution) -->
  <rect x="300" y="258" width="12" height="16" rx="1" fill="#3b82f6" opacity="0.5"/>
  <rect x="316" y="250" width="12" height="24" rx="1" fill="#3b82f6" opacity="0.6"/>
  <rect x="332" y="240" width="12" height="34" rx="1" fill="#3b82f6" opacity="0.7"/>
  <rect x="348" y="236" width="12" height="38" rx="1" fill="#3b82f6" opacity="0.8"/>
  <rect x="364" y="244" width="12" height="30" rx="1" fill="#3b82f6" opacity="0.75"/>
  <rect x="380" y="252" width="12" height="22" rx="1" fill="#3b82f6" opacity="0.6"/>
  <rect x="396" y="260" width="12" height="14" rx="1" fill="#3b82f6" opacity="0.5"/>
  <rect x="412" y="264" width="12" height="10" rx="1" fill="#3b82f6" opacity="0.4"/>
  ...
  <rect x="450" y="234" width="28" height="12" rx="2" fill="color-mix(in srgb, #f59e0b 15%, #1e293b)"/>
  <text x="464" y="243" text-anchor="middle" font-size="7" fill="#f59e0b" font-weight="600">p95</text>
  <!-- Histogram label callout -->
  <rect x="540" y="244" width="140" height="28" rx="3" fill="#152238" stroke="#3b4a60" stroke-width="0.8"/>
  <text x="610" y="256" text-anchor="middle" font-size="7.5" fill="#3b82f6" font-weight="600">appears after 2+ runs</text>
  <text x="610" y="266" text-anchor="middle" font-size="7" fill="#a8b8cc">reveals latency distribution</text>

  <!-- ── Response JSON preview (below histogram) ──────────────────────────── -->
  <line x1="278" y1="286" x2="700" y2="286" stroke="#3b4a60" stroke-width="1"/>
  <rect x="278" y="286" width="422" height="16" fill="#1e293b"/>
  <text x="288" y="297" font-size="8" font-weight="600" fill="#f1f5f9">extensions.tracing</text>
  <text x="690" y="297" text-anchor="end" font-size="7.5" fill="#a8b8cc">Apollo Tracing v1</text>
  <rect x="278" y="302" width="422" height="50" fill="#0f172a"/>
  <text x="288" y="318" fill="#a8b8cc" font-size="7.5" font-family="monospace">&#123;</text>
  <text x="296" y="330" fill="#a8b8cc" font-size="7.5" font-family="monospace">  "version": 1, "startTime": "...",</text>
  ...
  <text x="42" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#f1f5f9">≈N badge</text>
  <text x="42" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">pre-execution</text>
  <line x1="76" y1="408" x2="106" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql11-arr)"/>
  <text x="138" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#f1f5f9">Execute</text>
  <text x="138" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">+ tracing ext</text>
  <line x1="172" y1="408" x2="202" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql11-arr)"/>
  <text x="238" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#f1f5f9">Waterfall</text>
  <text x="238" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">per-resolver</text>
  <line x1="276" y1="408" x2="306" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql11-arr)"/>
  <text x="342" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#f1f5f9">Sort by Duration</text>
  <text x="342" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">find bottleneck</text>
  <line x1="390" y1="408" x2="420" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql11-arr)"/>
  <text x="458" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#f1f5f9">Hover Row</text>
  <text x="458" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">tooltip: start+dur</text>
  <line x1="494" y1="408" x2="524" y2="408" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql11-arr)"/>
  <text x="576" y="406" text-anchor="middle" font-size="8" font-weight="600" fill="#3b82f6">Histogram</text>
  <text x="576" y="418" text-anchor="middle" font-size="7" fill="#a8b8cc">distribution + p95</text>
</svg>`,
  },
