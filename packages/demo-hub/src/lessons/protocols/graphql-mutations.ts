...
**What you'll build:** A complete create → inspect → delete → **re-delete** cycle using Carol as the test user. The lesson captures Carol's server-assigned id from the create response and passes it automatically to the delete mutation.`,
  ...
  <text x="350" y="21" text-anchor="middle" fill="#a8b8cc" font-size="11" font-weight="500">GraphQL Studio — Mutations</text>

  <!-- ── Connection bar ────────────────────────────────────────────────────── -->
  <rect x="8" y="38" width="684" height="28" rx="5" fill="#1e293b" stroke="#3b4a60" stroke-width="1"/>
  <rect x="16" y="43" width="280" height="18" rx="3" fill="#0f172a" stroke="#3b4a60" stroke-width="1"/>
  <text x="24" y="55" fill="#a8b8cc" font-size="9" font-family="monospace">localhost:4010/graphql</text>
  <rect x="306" y="43" width="68" height="18" rx="9" fill="#1a3324" stroke="#28c840" stroke-width="1"/>
  <text x="340" y="55" text-anchor="middle" font-size="8.5" fill="#28c840" font-weight="600">✓ Schema</text>
  <rect x="560" y="43" width="72" height="18" rx="4" fill="#3b82f6"/>
  <text x="596" y="55" text-anchor="middle" font-size="9.5" font-weight="700" fill="white">▶ Execute</text>

  <!-- ── Tab bar ───────────────────────────────────────────────────────────── -->
  <rect x="8" y="72" width="684" height="24" fill="#0f172a" rx="0"/>
  <line x1="8" y1="96" x2="692" y2="96" stroke="#3b4a60" stroke-width="1"/>

  <!-- Tab 1: CreateUser — ACTIVE, amber M badge -->
  <rect x="12" y="74" width="122" height="20" rx="4" fill="#1e293b" stroke="#3b4a60" stroke-width="1"/>
  ...
  <text x="54" y="88" text-anchor="middle" font-size="8.5" fill="#f1f5f9" font-weight="500">CreateUser</text>

  <!-- Tab 2: CreateOrder — inactive amber M -->
  <rect x="140" y="74" width="122" height="20" rx="4" fill="#0f172a" stroke="#3b4a60" stroke-width="0.5"/>
  ...
  <text x="182" y="88" text-anchor="middle" font-size="8.5" fill="#a8b8cc">CreateOrder</text>

  <!-- Tab 3: DeleteUser — inactive amber M -->
  <rect x="268" y="74" width="108" height="20" rx="4" fill="#0f172a" stroke="#3b4a60" stroke-width="0.5"/>
  ...
  <text x="309" y="88" text-anchor="middle" font-size="8.5" fill="#a8b8cc">DeleteUser</text>

  <!-- ── Editor pane (left 54%) ─────────────────────────────────────────────── -->
  <rect x="8" y="96" width="380" height="186" fill="#0f172a" stroke="none"/>
  <line x1="388" y1="96" x2="388" y2="282" stroke="#3b4a60" stroke-width="1"/>

  <!-- Mode buttons -->
  <rect x="16" y="101" width="48" height="15" rx="3" fill="#243044" stroke="#3b82f6" stroke-width="0.8"/>
  <text x="40" y="112" text-anchor="middle" font-size="8" fill="#3b82f6" font-weight="600">Editor</text>
  <rect x="68" y="101" width="48" height="15" rx="3" fill="#0f172a"/>
  <text x="92" y="112" text-anchor="middle" font-size="8" fill="#a8b8cc">Builder</text>

  <!-- Line numbers -->
  <text x="16" y="128" fill="#a8b8cc" font-size="8.5" opacity="0.4" font-family="monospace">1</text>
  <text x="16" y="142" fill="#a8b8cc" font-size="8.5" opacity="0.4" font-family="monospace">2</text>
  <text x="16" y="156" fill="#a8b8cc" font-size="8.5" opacity="0.4" font-family="monospace">3</text>
  <text x="16" y="170" fill="#a8b8cc" font-size="8.5" opacity="0.4" font-family="monospace">4</text>
  <text x="16" y="184" fill="#a8b8cc" font-size="8.5" opacity="0.4" font-family="monospace">5</text>
  <text x="16" y="198" fill="#a8b8cc" font-size="8.5" opacity="0.4" font-family="monospace">6</text>
  <text x="16" y="212" fill="#a8b8cc" font-size="8.5" opacity="0.4" font-family="monospace">7</text>
  <text x="16" y="226" fill="#a8b8cc" font-size="8.5" opacity="0.4" font-family="monospace">8</text>
  <text x="16" y="240" fill="#a8b8cc" font-size="8.5" opacity="0.4" font-family="monospace">9</text>

  <!-- Mutation code -->
  <text x="32" y="128" fill="#86efac" font-size="9" font-family="monospace">mutation</text>
  <text x="79" y="128" fill="#f1f5f9" font-size="9" font-family="monospace"> CreateUser(</text>
  <text x="40" y="142" fill="#c4b5fd" font-size="9" font-family="monospace">$name</text>
  <text x="76" y="142" fill="#f1f5f9" font-size="9" font-family="monospace">: </text>
  <text x="86" y="142" fill="#7dd3fc" font-size="9" font-family="monospace">String!</text>
  <text x="130" y="142" fill="#a8b8cc" font-size="9" font-family="monospace">,</text>
  <text x="40" y="156" fill="#c4b5fd" font-size="9" font-family="monospace">$email</text>
  <text x="78" y="156" fill="#f1f5f9" font-size="9" font-family="monospace">: </text>
  <text x="88" y="156" fill="#7dd3fc" font-size="9" font-family="monospace">String!</text>
  <text x="132" y="156" fill="#f1f5f9" font-size="9" font-family="monospace">) {</text>
  <text x="32" y="170" fill="#86efac" font-size="9" font-family="monospace">  createUser</text>
  <text x="102" y="170" fill="#f1f5f9" font-size="9" font-family="monospace">(name: </text>
  <text x="143" y="170" fill="#c4b5fd" font-size="9" font-family="monospace">$name</text>
  <text x="175" y="170" fill="#f1f5f9" font-size="9" font-family="monospace">,</text>
  <text x="48" y="184" fill="#f1f5f9" font-size="9" font-family="monospace">       email: </text>
  <text x="130" y="184" fill="#c4b5fd" font-size="9" font-family="monospace">$email</text>
  <text x="164" y="184" fill="#f1f5f9" font-size="9" font-family="monospace">) {</text>
  <text x="48" y="198" fill="#a8b8cc" font-size="9" font-family="monospace">  id  name  email</text>
  <text x="32" y="212" fill="#f1f5f9" font-size="9" font-family="monospace">  }</text>
  <text x="32" y="226" fill="#f1f5f9" font-size="9" font-family="monospace">}</text>

  <!-- ── Response pane (right 46%) ──────────────────────────────────────────── -->
  <rect x="390" y="96" width="302" height="186" fill="#0f172a"/>

  <!-- Response header -->
  <rect x="390" y="96" width="302" height="22" fill="#1e293b" stroke="none"/>
  <line x1="390" y1="118" x2="692" y2="118" stroke="#3b4a60" stroke-width="1"/>
  <text x="400" y="111" font-size="9" font-weight="600" fill="#f1f5f9">Response</text>
  <rect x="466" y="99" width="34" height="14" rx="7" fill="#1a3324" stroke="#28c840" stroke-width="0.8"/>
  <text x="483" y="110" text-anchor="middle" font-size="7.5" fill="#28c840" font-weight="600">200</text>
  <text x="510" y="111" font-size="7.5" fill="#a8b8cc">34ms · POST</text>

  <!-- JSON response -->
  <text x="402" y="136" fill="#f1f5f9" font-size="8.5" font-family="monospace">{</text>
  <text x="402" y="149" fill="#a8b8cc" font-size="8.5" font-family="monospace">  "data": {</text>
  <text x="402" y="162" fill="#a8b8cc" font-size="8.5" font-family="monospace">    "createUser": {</text>
  <text x="402" y="175" fill="#a8b8cc" font-size="8.5" font-family="monospace">      "id": </text>
  <text x="449" y="175" fill="#7dd3fc" font-size="8.5" font-family="monospace">"usr-1"</text>
  <text x="402" y="188" fill="#a8b8cc" font-size="8.5" font-family="monospace">      "name": </text>
  <text x="455" y="188" fill="#86efac" font-size="8.5" font-family="monospace">"Carol"</text>
  <text x="402" y="201" fill="#a8b8cc" font-size="8.5" font-family="monospace">      "email": </text>
  <text x="456" y="201" fill="#7dd3fc" font-size="8.5" font-family="monospace">"carol@demo.local"</text>
  <text x="402" y="214" fill="#a8b8cc" font-size="8.5" font-family="monospace">    }  }  }</text>

  <!-- id captured callout -->
  <rect x="540" y="168" width="144" height="28" rx="4" fill="color-mix(in srgb, #7dd3fc 10%, #1e293b)" stroke="#7dd3fc" stroke-width="1"/>
  ...
  <rect x="8" y="282" width="684" height="64" fill="#1e293b" stroke="#3b4a60" stroke-width="1" rx="0"/>
  <line x1="8" y1="282" x2="692" y2="282" stroke="#3b4a60" stroke-width="1"/>
  <rect x="16" y="286" width="62" height="16" rx="3" fill="#1e293b" stroke="#3b4a60" stroke-width="1"/>
  <text x="47" y="297" text-anchor="middle" font-size="8" fill="#f1f5f9" font-weight="600">Variables</text>
  <rect x="82" y="286" width="54" height="16" rx="3" fill="#0f172a"/>
  <text x="109" y="297" text-anchor="middle" font-size="8" fill="#a8b8cc">Headers</text>
  <text x="16" y="318" fill="#f1f5f9" font-size="8.5" font-family="monospace">{ </text>
  <text x="28" y="318" fill="#7dd3fc" font-size="8.5" font-family="monospace">"name"</text>
  <text x="68" y="318" fill="#f1f5f9" font-size="8.5" font-family="monospace">: </text>
  <text x="78" y="318" fill="#86efac" font-size="8.5" font-family="monospace">"Carol"</text>
  <text x="118" y="318" fill="#f1f5f9" font-size="8.5" font-family="monospace">, </text>
  <text x="130" y="318" fill="#7dd3fc" font-size="8.5" font-family="monospace">"email"</text>
  <text x="172" y="318" fill="#f1f5f9" font-size="8.5" font-family="monospace">: </text>
  <text x="182" y="318" fill="#86efac" font-size="8.5" font-family="monospace">"carol@demo.local"</text>
  <text x="310" y="318" fill="#f1f5f9" font-size="8.5" font-family="monospace"> }</text>
  <text x="16" y="334" fill="#a8b8cc" font-size="7.5" opacity="0.7">Variables travel in a separate JSON field — never interpolated into the query (injection-safe by design)</text>

  <!-- ── Three-mutation legend (bottom) ─────────────────────────────────────── -->
  <line x1="8" y1="348" x2="692" y2="348" stroke="#3b4a60" stroke-width="1"/>
  <rect x="8" y="348" width="684" height="76" fill="#0f172a" rx="0"/>
  <text x="350" y="366" text-anchor="middle" font-size="9.5" font-weight="600" fill="#a8b8cc">Three Mutations in This Lesson</text>

  <!-- createUser block -->
  <rect x="18" y="374" width="196" height="42" rx="5" fill="color-mix(in srgb, #28c840 12%, #1e293b)" stroke="#28c840" stroke-width="1"/>
  <text x="116" y="389" text-anchor="middle" font-size="9" font-weight="700" fill="#28c840">createUser</text>
  <text x="116" y="401" text-anchor="middle" font-size="7.5" fill="#a8b8cc">scalar args → new id</text>
  <text x="116" y="411" text-anchor="middle" font-size="7.5" fill="#a8b8cc" font-style="italic">(capture for deleteUser)</text>

  <!-- arrow 1 -->
  <line x1="214" y1="395" x2="238" y2="395" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#gql6-arr-a)"/>

  <!-- createOrder block -->
  <rect x="240" y="374" width="196" height="42" rx="5" fill="#1f3048" stroke="#3b82f6" stroke-width="1"/>
  <text x="338" y="389" text-anchor="middle" font-size="9" font-weight="700" fill="#3b82f6">createOrder</text>
  <text x="338" y="401" text-anchor="middle" font-size="7.5" fill="#a8b8cc">input object type</text>
  <text x="338" y="411" text-anchor="middle" font-size="7.5" fill="#a8b8cc">($input: OrderInput!)</text>

  <!-- arrow 2 -->
  <line x1="436" y1="395" x2="460" y2="395" stroke="#f59e0b" stroke-width="1.5" marker-end="url(#gql6-arr-b)"/>

  <!-- deleteUser block -->
  <rect x="462" y="374" width="224" height="42" rx="5" fill="color-mix(in srgb, #f59e0b 10%, #1e293b)" stroke="#f59e0b" stroke-width="1"/>
  <text x="574" y="389" text-anchor="middle" font-size="9" font-weight="700" fill="#f59e0b">deleteUser × 2</text>
  <text x="574" y="401" text-anchor="middle" font-size="7.5" fill="#a8b8cc">1st: success true</text>
  <text x="574" y="411" text-anchor="middle" font-size="7.5" fill="#a8b8cc">2nd: success false (idempotent)</text>
