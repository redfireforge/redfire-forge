...
- [x] **Response Headers in Results** — Capture and display response headers (currently only body)
- [x] **Request Log** — Show the exact request sent including resolved auth headers
