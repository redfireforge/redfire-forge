...
### Added
- **Kafka Integration (Phases 1–9)** — Full end-to-end Kafka support across server transport, UI settings, workflow nodes, runner, load policy, results publishing, and native Tauri transport.
