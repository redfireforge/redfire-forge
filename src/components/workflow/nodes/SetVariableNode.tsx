  ...
  return (
    <div className={`wf-node wf-node-setVariable ${stateClass} ${selected ? 'wf-node-selected' : ''}`}>
      <div className="wf-setvar-body">
        <span className="wf-setvar-icon">📝</span>
      ...
      <div className="wf-node-footer">
        <button type="button" className="wf-node-configure-badge" title="Configure variables" onClick={handleConfigure}>⚙ Configure</button>
      </div>
