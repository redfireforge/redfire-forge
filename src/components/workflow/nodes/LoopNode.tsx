  ...
  return (
    <div className={`wf-node wf-node-loop ${stateClass} ${selected ? 'wf-node-selected' : ''}`}>
      <div className="wf-loop-body">
        <span className="wf-loop-icon">🔄</span>
      ...
      <div className="wf-node-footer">
        <button type="button" className="wf-node-configure-badge" title="Configure this loop" onClick={handleConfigure}>⚙ Configure</button>
      </div>
