...
const OAS_LINTER_RULES = `url: https://mermade.github.io/oas-kit/default-rules.html
rules:
...
export function readFileSync(filePath: string, _encoding?: string): string {
  if (typeof filePath === 'string' && filePath.includes('rules.yaml')) {
    return OAS_LINTER_RULES;
  }
  throw unsupported();
}
