...
vi.mock('./components/MultiWebhookTestingPanel', () => ({
  default: function MultiWebhookStub(props: {
    workflow: Workflow;
    isRunning: boolean;
    onFireWebhook?: (
      nodeId: string,
...
function _makeSummary(overrides: Partial<TestSummary> = {}): TestSummary {
  return {
    tps: 1,
    avgResponseTime: 10,
    minResponseTime: 10,
