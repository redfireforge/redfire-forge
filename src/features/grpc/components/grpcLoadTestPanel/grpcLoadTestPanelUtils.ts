...
/** Maps numeric gRPC status codes (as strings) to their canonical names. */
export const GRPC_STATUS_NAMES: Record<string, string> = {
  '0': 'OK',
  '1': 'CANCELLED',
  '2': 'UNKNOWN',
  '3': 'INVALID_ARGUMENT',
...
/** Returns "CODE · NAME" if the code is a known numeric gRPC status, otherwise the raw code string. */
export function formatGrpcStatusCode(code: string): string {
