/**
 * GrpcTlsMtlsModal — gRPC TLS configuration modal using shared components.
 * Adds gRPC-specific tri-mode selector, secret field masking, and footer actions.
 */
...
/**
 * gRPC-specific shared TLS/mTLS modal.
 * Uses GrpcTlsConfigBody for tri-mode selector + secret field masking.
 */
export function GrpcTlsMtlsModal({
  open,
  tlsMode,
  tlsConfig,
  issues,
