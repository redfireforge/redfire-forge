...
The proxy binds a real TCP socket on \`localhost:3001\`. Browsers cannot open listening TCP sockets due to security sandboxing — that is a capability only native processes have. The Tauri desktop app owns the socket; the embedded WebView makes standard HTTP requests to it just like any other GraphQL endpoint.`,
  ...
  <text x="350" y="21" text-anchor="middle" fill="var(--text-muted)" font-size="11" font-weight="500">GraphQL Studio — Mock Server</text>
  ...
  <rect x="26" y="42" width="248" height="22" rx="3" fill="var(--bg)" stroke="var(--border)" stroke-width="1"/>
  <text x="34" y="57" fill="var(--primary)" font-size="8.5" font-family="monospace" font-weight="600">localhost:3001/api/graphql/mock</text>
  <rect x="282" y="42" width="68" height="22" rx="3" fill="var(--surface)" stroke="var(--border)" stroke-width="1"/>
  <text x="316" y="57" text-anchor="middle" fill="var(--text-muted)" font-size="8.5">⟳ Introspect</text>
  <rect x="358" y="42" width="68" height="22" rx="3" fill="var(--primary)"/>
  <text x="392" y="57" text-anchor="middle" fill="white" font-size="9" font-weight="700">▶ Execute</text>
  <rect x="434" y="42" width="92" height="22" rx="3" fill="color-mix(in srgb, #28c840 14%, var(--surface))" stroke="#28c840" stroke-width="1"/>
  <text x="480" y="57" text-anchor="middle" fill="#28c840" font-size="8.5" font-weight="600">✓ Schema loaded (9)</text>

  <!-- Studio activity bar -->
  <rect x="0" y="72" width="34" height="318" fill="var(--surface)" stroke="var(--border)" stroke-width="0.5"/>
  <rect x="4" y="82" width="26" height="26" rx="4" fill="var(--bg)" stroke="var(--border)" stroke-width="0.5"/>
  <circle cx="17" cy="95" r="6" fill="none" stroke="var(--text-muted)" stroke-width="1.2" opacity="0.45"/>
  <polyline points="17,92 17,95 19,97" fill="none" stroke="var(--text-muted)" stroke-width="1.2" opacity="0.45"/>
  <rect x="4" y="114" width="26" height="26" rx="4" fill="var(--bg)" stroke="var(--border)" stroke-width="0.5"/>
  <line x1="8" y1="122" x2="26" y2="122" stroke="var(--text-muted)" stroke-width="1.2" opacity="0.35"/>
  <line x1="8" y1="127" x2="26" y2="127" stroke="var(--text-muted)" stroke-width="1.2" opacity="0.35"/>
  <line x1="8" y1="132" x2="26" y2="132" stroke="var(--text-muted)" stroke-width="1.2" opacity="0.35"/>
  <rect x="4" y="146" width="26" height="26" rx="4" fill="color-mix(in srgb, var(--primary) 14%, var(--surface))" stroke="var(--primary)" stroke-width="1.2"/>
  <rect x="9" y="151" width="16" height="11" rx="1.5" fill="none" stroke="var(--primary)" stroke-width="1.2"/>
  <line x1="13" y1="167" x2="21" y2="167" stroke="var(--primary)" stroke-width="1.2"/>
  <line x1="17" y1="162" x2="17" y2="167" stroke="var(--primary)" stroke-width="1.2"/>

  <!-- Mock panel -->
  <rect x="34" y="72" width="228" height="318" fill="var(--bg)" stroke="var(--border)" stroke-width="0.5"/>
  <text x="46" y="90" font-size="10" font-weight="700" fill="var(--text)">Mock server</text>
  <text x="46" y="102" font-size="7.5" fill="var(--text-muted)">In-process GraphQL proxy for offline testing</text>

  <!-- Toggle card (ON) -->
  <rect x="42" y="110" width="212" height="34" rx="7" fill="color-mix(in srgb, var(--primary) 8%, var(--bg))" stroke="color-mix(in srgb, var(--primary) 45%, var(--border))" stroke-width="1"/>
  <rect x="52" y="121" width="34" height="18" rx="9" fill="var(--primary)"/>
  <circle cx="68" cy="130" r="6" fill="var(--bg)"/>
  <text x="94" y="131" font-size="8.5" font-weight="600" fill="var(--text)">Mock mode ON</text>

  <!-- Status row -->
  <rect x="46" y="150" width="58" height="14" rx="7" fill="color-mix(in srgb, #a6e3a1 16%, var(--surface))" stroke="color-mix(in srgb, #a6e3a1 35%, var(--border))" stroke-width="0.8"/>
  <text x="75" y="160" text-anchor="middle" font-size="7" fill="#a6e3a1" font-weight="600">Mock active</text>
  <rect x="108" y="150" width="52" height="14" rx="7" fill="var(--bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="134" y="160" text-anchor="middle" font-size="7" fill="var(--text-muted)">1 override</text>
  <rect x="164" y="150" width="38" height="14" rx="7" fill="var(--bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="183" y="160" text-anchor="middle" font-size="7" fill="var(--text-muted)">650ms</text>

  <!-- Schema source card -->
  <rect x="42" y="170" width="212" height="72" rx="7" fill="var(--surface)" stroke="var(--border)" stroke-width="1"/>
  <text x="50" y="184" font-size="7" fill="var(--text-muted)" font-weight="600" letter-spacing="0.4">SCHEMA SOURCE</text>
  <rect x="50" y="190" width="196" height="22" rx="5" fill="color-mix(in srgb, var(--primary) 8%, var(--bg))" stroke="var(--primary)" stroke-width="1"/>
  <text x="58" y="200" font-size="7.5" font-weight="600" fill="var(--text)">Introspected schema</text>
  <text x="58" y="209" font-size="6.5" fill="var(--text-muted)">Reuse SDL from the last introspection</text>
  <rect x="50" y="216" width="196" height="20" rx="5" fill="var(--bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="58" y="229" font-size="7.5" fill="var(--text-muted)">Custom SDL</text>

  <!-- Response timing card -->
  <rect x="42" y="248" width="212" height="58" rx="7" fill="var(--surface)" stroke="var(--border)" stroke-width="1"/>
  <text x="50" y="262" font-size="7" fill="var(--text-muted)" font-weight="600" letter-spacing="0.4">RESPONSE TIMING</text>
  <!-- Latency row (two-tone) -->
  <rect x="50" y="268" width="52" height="16" rx="3" fill="var(--bg)"/>
  <text x="54" y="279" font-size="7" fill="var(--text-muted)">Latency</text>
  <rect x="102" y="268" width="144" height="16" rx="3" fill="var(--surface)"/>
  <rect x="108" y="274" width="88" height="3" rx="1.5" fill="var(--border)"/>
  <rect x="108" y="274" width="28" height="3" rx="1.5" fill="var(--primary)"/>
  <circle cx="136" cy="275.5" r="4.5" fill="var(--primary)" stroke="var(--surface)" stroke-width="1.5"/>
  <text x="232" y="279" text-anchor="end" font-size="7" fill="var(--primary)" font-weight="700">650 ms</text>
  <!-- Jitter row -->
  <rect x="50" y="286" width="52" height="16" rx="3" fill="var(--bg)"/>
  <text x="54" y="297" font-size="7" fill="var(--text-muted)">Jitter</text>
  <rect x="102" y="286" width="144" height="16" rx="3" fill="var(--surface)"/>
  <rect x="108" y="290" width="18" height="8" rx="2" fill="var(--bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="112" y="297" font-size="6.5" fill="var(--text-muted)">0</text>
  <text x="132" y="297" font-size="6.5" fill="var(--text-muted)">± ms around latency</text>

  <!-- Panel tabs -->
  <rect x="42" y="312" width="212" height="20" rx="4" fill="var(--surface)" stroke="var(--border)" stroke-width="0.8"/>
  <rect x="44" y="314" width="52" height="16" rx="3" fill="color-mix(in srgb, var(--primary) 12%, var(--bg))"/>
  <text x="70" y="325" text-anchor="middle" font-size="7" fill="var(--primary)" font-weight="600">Resolvers</text>
  <text x="118" y="325" text-anchor="middle" font-size="7" fill="var(--text-muted)">Scenarios</text>
  <text x="162" y="325" text-anchor="middle" font-size="7" fill="var(--text-muted)">Scalars</text>
  <text x="214" y="325" text-anchor="middle" font-size="7" fill="var(--text-muted)">Request log</text>

  <!-- Resolver tree -->
  <rect x="42" y="336" width="212" height="18" rx="3" fill="color-mix(in srgb, var(--primary) 5%, var(--bg))"/>
  <text x="50" y="348" font-size="7.5" font-weight="600" fill="var(--text)">▾ Query</text>
  <text x="228" y="348" text-anchor="end" font-size="6.5" fill="var(--primary)">1</text>
  <rect x="42" y="354" width="212" height="24" rx="3" fill="var(--bg)" stroke="var(--border)" stroke-width="0.5"/>
  <text x="54" y="368" font-size="7.5" fill="var(--text)" font-family="monospace">health</text>
  <text x="92" y="368" font-size="6.5" fill="var(--text-muted)" font-family="monospace">String</text>
  <rect x="128" y="360" width="38" height="12" rx="2" fill="color-mix(in srgb, #28c840 10%, var(--surface))" stroke="#28c840" stroke-width="0.8"/>
  <text x="147" y="369" text-anchor="middle" font-size="6.5" fill="#28c840" font-weight="600">Fixed</text>
  <rect x="170" y="360" width="76" height="12" rx="2" fill="var(--bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="176" y="369" font-size="6.5" fill="var(--primary)" font-family="monospace">"mock-ok"</text>

  <!-- Editor pane -->
  <rect x="262" y="72" width="196" height="318" rx="4" fill="var(--surface)" stroke="var(--border)" stroke-width="1"/>
  <rect x="262" y="72" width="196" height="22" fill="var(--bg)" stroke="var(--border)" stroke-width="0.5"/>
  <rect x="268" y="76" width="44" height="14" rx="3" fill="var(--surface)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="290" y="86" text-anchor="middle" font-size="7.5" fill="var(--text)" font-weight="600">Editor</text>
  <text x="332" y="86" font-size="7.5" fill="var(--text-muted)">Builder</text>
  <rect x="262" y="94" width="196" height="296" fill="var(--bg)"/>
  <text x="272" y="112" fill="var(--text-muted)" font-size="8" opacity="0.45">1</text>
  <text x="286" y="112" fill="#a78bfa" font-size="9" font-family="monospace">query</text>
  <text x="322" y="112" fill="var(--text)" font-size="9" font-family="monospace"> {</text>
  <text x="272" y="128" fill="var(--text-muted)" font-size="8" opacity="0.45">2</text>
  <text x="294" y="128" fill="#34d399" font-size="9" font-family="monospace">  health</text>
  <text x="272" y="144" fill="var(--text-muted)" font-size="8" opacity="0.45">3</text>
  <text x="286" y="144" fill="var(--text)" font-size="9" font-family="monospace">}</text>

  <!-- Response pane -->
  <rect x="458" y="72" width="234" height="318" rx="4" fill="var(--surface)" stroke="var(--border)" stroke-width="1"/>
  <rect x="458" y="72" width="234" height="22" fill="var(--bg)" stroke="var(--border)" stroke-width="0.5"/>
  <rect x="464" y="76" width="54" height="14" rx="3" fill="color-mix(in srgb, var(--primary) 12%, var(--bg))"/>
  <text x="491" y="86" text-anchor="middle" font-size="7.5" fill="var(--primary)" font-weight="600">Response</text>
  <text x="536" y="86" font-size="7.5" fill="var(--text-muted)">Schema</text>
  <rect x="458" y="94" width="234" height="296" fill="var(--bg)"/>
  <rect x="466" y="100" width="28" height="12" rx="2" fill="color-mix(in srgb, #28c840 14%, var(--surface))" stroke="#28c840" stroke-width="0.6"/>
  <text x="480" y="109" text-anchor="middle" font-size="6.5" fill="#28c840" font-weight="600">200 OK</text>
  <rect x="500" y="100" width="42" height="12" rx="2" fill="color-mix(in srgb, var(--primary) 12%, var(--surface))" stroke="var(--primary)" stroke-width="0.6"/>
  <text x="521" y="109" text-anchor="middle" font-size="6.5" fill="var(--primary)" font-weight="600">650 ms</text>
  <text x="470" y="128" fill="var(--text)" font-size="8.5" font-family="monospace">{</text>
  <text x="478" y="142" fill="var(--text-muted)" font-size="8.5" font-family="monospace">  "data": {</text>
  <text x="486" y="156" fill="var(--text-muted)" font-size="8.5" font-family="monospace">    "health":</text>
  <text x="548" y="156" fill="var(--primary)" font-size="8.5" font-family="monospace"> "mock-ok"</text>
  <text x="478" y="170" fill="var(--text-muted)" font-size="8.5" font-family="monospace">  }</text>
  <text x="470" y="184" fill="var(--text)" font-size="8.5" font-family="monospace">}</text>
  <rect x="536" y="148" width="118" height="16" rx="3" fill="color-mix(in srgb, var(--primary) 10%, var(--surface))" stroke="var(--primary)" stroke-width="0.8"/>
  <text x="595" y="159" text-anchor="middle" font-size="7" fill="var(--primary)" font-weight="600">← Fixed resolver value</text>

  <!-- Bottom workflow legend -->
  <line x1="0" y1="396" x2="700" y2="396" stroke="var(--border)" stroke-width="1"/>
  <rect x="0" y="396" width="700" height="34" fill="var(--bg)"/>
  <text x="38" y="412" text-anchor="middle" font-size="8" font-weight="600" fill="var(--text)">Enable</text>
  <text x="38" y="422" text-anchor="middle" font-size="7" fill="var(--text-muted)">mock on</text>
  <line x1="66" y1="414" x2="90" y2="414" stroke="var(--primary)" stroke-width="1.5" marker-end="url(#gql13-arr)"/>
  <text x="126" y="412" text-anchor="middle" font-size="8" font-weight="600" fill="var(--text)">Introspect</text>
  <text x="126" y="422" text-anchor="middle" font-size="7" fill="var(--text-muted)">schema source</text>
  <line x1="160" y1="414" x2="184" y2="414" stroke="var(--primary)" stroke-width="1.5" marker-end="url(#gql13-arr)"/>
  <text x="224" y="412" text-anchor="middle" font-size="8" font-weight="600" fill="var(--text)">Override</text>
  <text x="224" y="422" text-anchor="middle" font-size="7" fill="var(--text-muted)">resolver → Fixed</text>
  <line x1="258" y1="414" x2="284" y2="414" stroke="var(--primary)" stroke-width="1.5" marker-end="url(#gql13-arr)"/>
  <text x="322" y="412" text-anchor="middle" font-size="8" font-weight="600" fill="var(--text)">Execute</text>
  <text x="322" y="422" text-anchor="middle" font-size="7" fill="var(--primary)">"mock-ok"</text>
  <line x1="352" y1="414" x2="376" y2="414" stroke="var(--primary)" stroke-width="1.5" marker-end="url(#gql13-arr)"/>
  <text x="418" y="412" text-anchor="middle" font-size="8" font-weight="600" fill="var(--primary)">+ 650 ms</text>
  <text x="418" y="422" text-anchor="middle" font-size="7" fill="var(--text-muted)">Response timing</text>
  <line x1="448" y1="414" x2="474" y2="414" stroke="var(--primary)" stroke-width="1.5" marker-end="url(#gql13-arr)"/>
  <text x="520" y="412" text-anchor="middle" font-size="8" font-weight="600" fill="#28c840">Restore</text>
  <text x="520" y="422" text-anchor="middle" font-size="7" fill="var(--text-muted)">live :4010</text>
  <line x1="554" y1="414" x2="578" y2="414" stroke="var(--primary)" stroke-width="1.5" marker-end="url(#gql13-arr)"/>
  <text x="624" y="412" text-anchor="middle" font-size="8" font-weight="600" fill="#28c840">Verify</text>
  <text x="624" y="422" text-anchor="middle" font-size="7" fill="var(--text-muted)">"ok" returns</text>
</svg>`,
  },
