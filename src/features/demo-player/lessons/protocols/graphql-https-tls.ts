...
| \`https://localhost:4443\` (CA cert) | ✅ AES-256 | ✅ Full chain |`,
  ...
  <text x="350" y="21" text-anchor="middle" fill="var(--text-muted)" font-size="11" font-weight="500">GraphQL Studio — HTTPS, TLS &amp; Certificates</text>
  ...
  <!-- HTTPS endpoint -->
  <rect x="34" y="42" width="360" height="22" rx="3" fill="var(--bg)" stroke="#28c840" stroke-width="1.2"/>
  <text x="42" y="57" fill="#28c840" font-size="10" font-family="monospace">https://localhost:4443/graphql</text>
  <!-- Introspect -->
  <rect x="402" y="42" width="72" height="22" rx="3" fill="var(--surface)" stroke="var(--border)" stroke-width="1"/>
  <text x="438" y="57" text-anchor="middle" fill="var(--text-muted)" font-size="9">⟳ Introspect</text>
  <!-- SSL toggle — active (highlighted) -->
  <rect x="482" y="42" width="52" height="22" rx="3" fill="color-mix(in srgb, #febc2e 18%, var(--surface))" stroke="#febc2e" stroke-width="1.5"/>
  ...
  <!-- Schema badge OK -->
  <rect x="620" y="42" width="62" height="22" rx="3" fill="color-mix(in srgb, #28c840 15%, var(--surface))" stroke="#28c840" stroke-width="1"/>
  ...
  <rect x="358" y="78" width="64" height="16" rx="3" fill="var(--surface)" stroke="var(--border)" stroke-width="1"/>
  <text x="390" y="89" text-anchor="middle" fill="var(--text)" font-size="9" font-weight="600">Response</text>
  <rect x="428" y="78" width="50" height="16" rx="3" fill="none"/>
  <text x="453" y="89" text-anchor="middle" fill="var(--text-muted)" font-size="9">Schema</text>
  <!-- Response body -->
  <rect x="350" y="98" width="342" height="172" fill="var(--bg)"/>
  <!-- Sub-tabs -->
  <rect x="358" y="104" width="38" height="14" rx="2" fill="color-mix(in srgb, var(--primary) 12%, var(--bg))"/>
  <text x="377" y="114" text-anchor="middle" fill="var(--primary)" font-size="8" font-weight="600">Body</text>
  <text x="412" y="114" fill="var(--text-muted)" font-size="8">Headers</text>
  <text x="450" y="114" fill="var(--text-muted)" font-size="8">Metadata</text>
  <!-- JSON response -->
  <text x="366" y="134" fill="var(--text)" font-size="9" font-family="monospace">{</text>
  <text x="376" y="148" fill="var(--text-muted)" font-size="9" font-family="monospace">  "data": {</text>
  <text x="386" y="162" fill="#34d399" font-size="9" font-family="monospace">    "health": "ok"</text>
  <text x="376" y="176" fill="var(--text-muted)" font-size="9" font-family="monospace">  }</text>
  <text x="366" y="190" fill="var(--text)" font-size="9" font-family="monospace">}</text>
  <!-- TLS encrypted indicator -->
  <rect x="510" y="128" width="170" height="42" rx="4" fill="color-mix(in srgb, #28c840 10%, var(--bg))" stroke="#28c840" stroke-width="1"/>
  ...
  <text x="350" y="322" text-anchor="middle" fill="var(--text-muted)" font-size="9" font-weight="600" opacity="0.7">TLS connection flow</text>

  <!-- Phase 1: https:// URL -->
  <rect x="8" y="330" width="152" height="54" rx="5" fill="var(--surface)" stroke="var(--border)" stroke-width="1"/>
  <rect x="8" y="330" width="152" height="18" rx="5" fill="color-mix(in srgb, #28c840 15%, var(--surface))"/>
  <rect x="8" y="340" width="152" height="8" fill="color-mix(in srgb, #28c840 15%, var(--surface))"/>
  <text x="84" y="342" text-anchor="middle" fill="#28c840" font-size="8.5" font-weight="700">① https:// URL</text>
  <text x="84" y="356" text-anchor="middle" fill="var(--text-muted)" font-size="8">Change endpoint to</text>
  <text x="84" y="366" text-anchor="middle" fill="#28c840" font-size="7.5" font-family="monospace">https://…4443/graphql</text>
  <text x="84" y="376" text-anchor="middle" fill="var(--text-muted)" font-size="8">SSL toggle appears</text>

  <!-- Phase 2: Skip-cert -->
  <rect x="168" y="330" width="152" height="54" rx="5" fill="var(--surface)" stroke="var(--border)" stroke-width="1"/>
  <rect x="168" y="330" width="152" height="18" rx="5" fill="color-mix(in srgb, #febc2e 12%, var(--surface))"/>
  <rect x="168" y="340" width="152" height="8" fill="color-mix(in srgb, #febc2e 12%, var(--surface))"/>
  <text x="244" y="342" text-anchor="middle" fill="#febc2e" font-size="8.5" font-weight="700">② SSL toggle</text>
  <text x="244" y="356" text-anchor="middle" fill="var(--text-muted)" font-size="8">Click to enable</text>
  <text x="244" y="366" text-anchor="middle" fill="var(--text-muted)" font-size="8">skip-cert mode</text>
  <text x="244" y="376" text-anchor="middle" fill="var(--text-muted)" font-size="8">(dev only — not safe)</text>

  <!-- Phase 3: Introspect -->
  <rect x="328" y="330" width="152" height="54" rx="5" fill="var(--surface)" stroke="var(--border)" stroke-width="1"/>
  <rect x="328" y="330" width="152" height="18" rx="5" fill="color-mix(in srgb, var(--primary) 12%, var(--surface))"/>
  <rect x="328" y="340" width="152" height="8" fill="color-mix(in srgb, var(--primary) 12%, var(--surface))"/>
  <text x="404" y="342" text-anchor="middle" fill="var(--primary)" font-size="8.5" font-weight="700">③ Introspect</text>
  <text x="404" y="356" text-anchor="middle" fill="var(--text-muted)" font-size="8">Schema loads over</text>
  <text x="404" y="366" text-anchor="middle" fill="var(--text-muted)" font-size="8">encrypted tunnel</text>
  <text x="404" y="376" text-anchor="middle" fill="var(--text-muted)" font-size="8">despite self-signed cert</text>

  <!-- Phase 4: Credentials inside TLS -->
  <rect x="488" y="330" width="204" height="54" rx="5" fill="var(--surface)" stroke="var(--border)" stroke-width="1"/>
  <rect x="488" y="330" width="204" height="18" rx="5" fill="color-mix(in srgb, #34d399 12%, var(--surface))"/>
  <rect x="488" y="340" width="204" height="8" fill="color-mix(in srgb, #34d399 12%, var(--surface))"/>
  <text x="590" y="342" text-anchor="middle" fill="#34d399" font-size="8.5" font-weight="700">④ Credentials inside TLS</text>
  <text x="590" y="356" text-anchor="middle" fill="var(--text-muted)" font-size="8">Auth headers travel</text>
  <text x="590" y="366" text-anchor="middle" fill="var(--text-muted)" font-size="8">encrypted — never in</text>
  <text x="590" y="376" text-anchor="middle" fill="var(--text-muted)" font-size="8">plain text over the wire</text>

  <!-- Flow arrows -->
  <line x1="160" y1="357" x2="168" y2="357" stroke="var(--border)" stroke-width="1.5" marker-end="url(#arr2)"/>
  <line x1="320" y1="357" x2="328" y2="357" stroke="var(--border)" stroke-width="1.5" marker-end="url(#arr2)"/>
  <line x1="480" y1="357" x2="488" y2="357" stroke="var(--border)" stroke-width="1.5" marker-end="url(#arr2)"/>
