...
const LESSONS_ROOT = join(process.cwd(), 'src/features/demo-player/lessons');
const DEMO_PLAYER_ROOT = join(process.cwd(), 'src/features/demo-player');
const ADAPTERS_ROOT = join(process.cwd(), 'src/features/demo-player/adapters');
