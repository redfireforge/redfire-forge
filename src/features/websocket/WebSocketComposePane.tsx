...
export interface WebSocketComposePaneProps extends UseWebSocketComposeOptions {
 ...
 * standalone, reusable pane. It wraps the existing `useWebSocketCompose` hook
 ...
 * Phase 4.
 */
export function WebSocketComposePane({ hidden = false, ...options }: WebSocketComposePaneProps) {
  const { composeBar } = useWebSocketCompose(options);
