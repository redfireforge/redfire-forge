  ...
  return (
    <div className="wf-config-body" data-testid="kafka-trigger-config">
      ...
      <div className="wf-config-field">
        ...
        />
        <span className="wf-config-hint">Leave empty to use the default deterministic group ID.</span>
      </div>
      ...
      <div className="wf-config-field">
        ...
        <input
          ...
          placeholder="10"
        />
        <span className="wf-config-hint">Backpressure limit — consumer pauses when this many runs are active.</span>
      </div>
