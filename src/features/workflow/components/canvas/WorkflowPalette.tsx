...
const ALL_BLOCKS: BlockDef[] = [
  ...
  { type: 'grpcUnary', title: 'gRPC Unary', desc: 'Execute a unary gRPC call', category: 'actions' },
  { type: 'grpcServerStream', title: 'gRPC Server Stream', desc: 'Execute and collect a server stream', category: 'actions' },
