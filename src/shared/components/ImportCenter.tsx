...
export default function ImportCenter({ environments, microservices, featureGroups, appGlobalAuthProfiles, onImport, onClose }: Props) {
  ...
  return (
    <AppModalFrame
      ...
      dialogClassName="settings-modal import-center-modal"
      headerClassName="settings-header"
      bodyClassName="import-center-body"
      footerClassName="import-center-footer"
      controlsClassName="import-header-actions"
      closeButtonKind="text"
      footer={(
        <>
          <button className="btn btn-sm" onClick={onClose}>Cancel</button>
          <button className="btn btn-primary" onClick={handleImport} disabled={!parsed}>Import</button>
        </>
      )}
    >
