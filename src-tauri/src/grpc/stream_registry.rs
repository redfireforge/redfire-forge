...
pub use crate::grpc::stream_registry_types::{
    StreamControlOutcome, StreamOutbound, StreamRegistryEntry, StreamRegistryStats,
    StreamRegistryStatus, TryRegisterStreamOutcome,
};
