...
# The leaf certs embedded in graphql-https-tls.ts were signed by the EXISTING CA.
# Regenerating would produce a NEW CA that no longer matches the embedded certs.
